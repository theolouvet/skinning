...
//    /** Create cylinder */
//    static cpe::mesh_skinned build_cylindre(float const radius,float const length, int const Nu, int const Nv);
    ...
    void build_skeletton();
    void build_skeletton_animation();
